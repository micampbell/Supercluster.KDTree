...
namespace SuperClusterKDTreeSpan.Utilities
{
        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        private int GetInsertIndex(TPriority priority)
        {
            // BinarySearch via span to avoid extra virtual calls
            var span = CollectionsMarshal.AsSpan(this.priorityList);
            int idx = span.BinarySearch(priority);
