...
namespace SuperClusterKDTreeSpan.Utilities
{
    ...
    internal class BinaryTreeNavigator<TPoint, TNode>
    {
        ...
        internal BinaryTreeNavigator<TPoint, TNode> Left
            =>
                LeftChildIndex(this.Index) < this.pointArray.Count
        ...
        internal BinaryTreeNavigator<TPoint, TNode> Right
               =>
                   RightChildIndex(this.Index) < this.pointArray.Count
        ...
        internal TPoint Point
        {
            get
            {
                if (this.pointArray is List<TPoint> list)
                {
                    return CollectionsMarshal.AsSpan(list)[this.Index];
                }

                return this.pointArray[this.Index];
            }
        }
        ...
        internal TNode Node
        {
            get
            {
                if (this.nodeArray is List<TNode> list)
                {
                    return CollectionsMarshal.AsSpan(list)[this.Index];
                }
