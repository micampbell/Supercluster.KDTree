...
namespace NearestNeighborSearchKDTree
{
    ...
    internal class BinaryTreeNavigator<TPoint, TNode>
    {
        ...
        internal BinaryTreeNavigator<TPoint, TNode> Left
            =>
                LeftChildIndex(Index) < pointArray.Count - 1
        ...
        internal BinaryTreeNavigator<TPoint, TNode> Right
               =>
                   RightChildIndex(Index) < pointArray.Count - 1
        ...
        /// </summary>
        internal BinaryTreeNavigator<TPoint, TNode> Parent => Index == 0 ? null : new BinaryTreeNavigator<TPoint, TNode>(pointArray, nodeArray, ParentIndex(Index));
        ...
        /// </summary>
        internal TNode Node => nodeArray[Index];
