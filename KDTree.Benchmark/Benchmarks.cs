...
namespace KDTree.Benchmark
{
    ...
    public class Benchmarks
    {
        ...
        [Benchmark]
        [BenchmarkCategory("Construction")]
        public SuperClusterKDTreeSpan.KDTree<double, double, string> KDTreePQ_Construction()
        {
    ...
    public class FloatPrecisionBenchmarks
    {
        ...
        {
            var tree = new SuperClusterKDTreeSpan.KDTree<float, float, string>(Dimensions, _floatPoints, _nodes, FloatL2Metric);
            int totalResults = 0;
